...
import javax.swing.*;
import java.sql.*;
public class Insert2 extends JFrame implements ActionListener {
      ...
      //   btn = new JButton("INSERT");
        ...
        // btn1 = new JButton("UPDATE");
          // btn1.setBounds(760,570,100,30);
           ...
           p1.setBounds(700,200,250,30);
           
           p2=new JPasswordField();
           p2.setBounds(700,250,250,30);
  ...
  //         add(t6);
    ...
    { 
       ...
       String str2=new String(p);
        char[]q=p2.getPassword();
       String str3=new String(q);
       if(p==q)
       {
            JOptionPane.showMessageDialog(null, "PASSWORD MATCH");
           stmt.executeUpdate("insert into reg(name,pwd) values ('"+str1+"','"+str2+"')");
